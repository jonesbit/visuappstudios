                ...
                <div className="space-y-4">
                    ...
                    <div className="group bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-lg hover:border-visu-primary/30" data-aos="fade-up" data-aos-delay="0">
                        <details className="group p-6 [&_summary::-webkit-details-marker]:hidden">
                            <summary className="flex justify-between items-center font-bold text-visu-black text-lg list-none select-none cursor-pointer">
                            ...
                            <div className="text-gray-500 mt-4 leading-relaxed text-sm animate-fade-in-down cursor-text">
